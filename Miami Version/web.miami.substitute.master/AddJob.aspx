<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="AddJob.aspx.cs" Inherits="Miami.Substitute.Web.Master.AddJob" %>
    ...
    <asp:Table ID="AddJobPanelTable" runat="server" Width="430px">
        <asp:TableRow ID="TableRow1" runat="server">
            ...
            <asp:TableCell ID="TableCell2" runat="server">
                &nbsp;&nbsp;<telerik:RadDatePicker ClientEvents-OnDateSelected="OnDateSelected" runat="server"
                    Skin="WebBlue" AutoPostBack="false" ID="StartDate" Calendar-ShowRowHeaders="false" />
                &nbsp;&nbsp;&nbsp;&nbsp;<telerik:RadTimePicker ClientEvents-OnDateSelected="OnDateSelected" runat="server" Skin="WebBlue" ID="StartTimePicker" />
            </asp:TableCell>
        </asp:TableRow>
        <asp:TableRow ID="TableRow2" runat="server">
            <asp:TableCell ID="TableCell3" runat="server" Width="140px" Wrap="false" meta:resourcekey="JobForm_endDate" />
            <asp:TableCell ID="TableCell4" runat="server">
                &nbsp;&nbsp;<telerik:RadDatePicker runat="server" ClientEvents-OnDateSelected="OnDateSelected" Skin="WebBlue" ID="EndDate" Calendar-ShowRowHeaders="false" />
                &nbsp;&nbsp;&nbsp;&nbsp;<telerik:RadTimePicker ClientEvents-OnDateSelected="OnDateSelected" runat="server" Skin="WebBlue" ID="EndTimePicker" />
        ...
        <asp:TableFooterRow runat="server" TableSection="TableFooter">
            <asp:TableCell runat="server" ColumnSpan="2" Style="padding-left: 136px">
                <asp:Button runat="server" ID="AddButton" OnClick="SaveButton_Click" ValidationGroup="UserForm"
                    Text="Add Job" />&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-weight: normal">or</font>&nbsp;&nbsp;&nbsp;&nbsp;<asp:LinkButton
